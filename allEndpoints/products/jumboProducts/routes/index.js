 ...
 * all products routes
 */
 router.options('/stores/jumboProducts', (req, res, next) => {
...
router.get('/stores/jumboProducts', cors(), getProducts);

// get an individual product
router.get('/stores/jumboProducts/:id', cors(), getProduct);
...
router.delete('/stores/jumboProducts/:id', cors(), (req, res, next) => {

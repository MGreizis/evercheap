        ...
        <div>
          <nav className="flex h-9 items-center justify-between" aria-label="Global">
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a className="flex items-center text-primary no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-tertiary">Evercheap</span>
              </a>
            </div>
            <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
              {navigation.map((item) => (
                <a key={item.name} href={item.href} className="font-semibold text-secondary hover:text-primary">
                  {item.name}
                </a>
              ))}
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-secondary sm:text-center">
                  Start saving money just by creating a shopping cart. Evercheap will help you find the best deals on the groceries you want.
                </p>
